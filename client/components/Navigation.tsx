...
const Navigation = () => {
  ...
  const pillBaseClasses = `bg-white border-2 border-black rounded-full flex items-center justify-between transition-all duration-300 w-full shadow-[5px_5px_0px_0px_#000000]`;
        ...
        <div className="lg:hidden">
          <div className={`${pillBaseClasses} h-[56px] px-4`}>
            ...
            <button
              ...
              className="flex items-center justify-center w-9 h-9 rounded-full border-2 border-black bg-white shadow-[2px_2px_0px_0px_#000000] hover:bg-gray-100 hover:shadow-[3px_3px_0px_0px_#000000] active:translate-x-[1px] active:translate-y-[1px] active:shadow-[1px_1px_0px_0px_#000000] transition-all"
